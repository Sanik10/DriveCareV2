...
import { 
  IsNotEmpty, IsString, IsUUID, IsDateString, IsArray, IsOptional, 
  IsEnum, IsNumber, IsEmail, IsPhoneNumber, ArrayMaxSize, ArrayMinSize,
  Min, Max, IsDecimal, MaxLength, ValidateIf 
